...
# -*- coding: utf-8 -*-
"""
勒布朗·詹姆斯主题站 · 新闻每日自动更新脚本
从公开 RSS 源抓取最新勒布朗新闻，重写：
  - data/news.json      （数据存档）
...
FEEDS = [
    ("Google 新闻", "https://news.google.com/rss/search?q=%E5%8B%92%E5%B8%83%E6%9C%97%C2%B7%E8%A9%B9%E5%A7%86%E6%96%AF&hl=zh-CN&gl=CN&ceid=CN:zh-Hans"),
    ("Google News", "https://news.google.com/rss/search?q=LeBron+James&hl=en-US&gl=US&ceid=US:en"),
    ("ESPN NBA", "https://www.espn.com/espn/rss/nba/news"),
]

KEYWORDS = ["lebron", "勒布朗", "詹姆斯", "lakers", "湖人", "76人", "76ers", "sixers", "king james"]
...
def main():
    ...
    data = {"updatedAt": now, "source": "每日自动更新 · Google News / ESPN RSS + 人工校准", "items": merged}
